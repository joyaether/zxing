...
- (id) initWithFrame:(CGRect)theFrame cancelEnabled:(BOOL)isCancelEnabled oneDMode:(BOOL)isOneDModeEnabled showLicense:(BOOL)showLicenseButton {
  ...
  if( self ) {
    ...
    if (!oneDMode) {
        CGFloat rectSize2 = 200;
        cropRect = CGRectMake(kPadding, [UIScreen mainScreen].applicationFrame.size.height/2 - rectSize2/2, rectSize, rectSize2);
    } else {
    ...
    self.cancelEnabled = isCancelEnabled;
      ...
      NSString *image = [UIScreen mainScreen].applicationFrame.size.height > 460 ? @"bg_scan_ip5.png" : @"bg_scan.png";
      UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:image]];
      imageView.contentMode = UIViewContentModeScaleToFill;
      [imageView setFrame:CGRectMake(0, 0, 320, [UIScreen mainScreen].applicationFrame.size.height-44)];;
